...
\end{figure}
In addition, we can start with a neutrally stable standing wave solution and perturb the system by a small change in $k$ or $\phi$. 
\begin{figure}[H]
\begin{center}
\begin{tabular}{cc}
...
, the time evolution resembles that in \cref{fig:evenhole6perturbed}.
