...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=7.80cm]{images/twist025.eps}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=4cm]{images/evenhole6perturbed.eps} & 
\includegraphics[width=4cm]{images/oddhole7perturbed.eps}
\end{tabular}
\end{center}
