...
\end{equation}
\revised{where there is a different coupling parameter $k_n$ for each pair of nodes. This could occur in an asymmetric configuration of waveguides. It could also be a consequence of small imprecisions in the fiber bundle construction, in which case the parameters $k_n$ would be close, but not identical.}
\begin{figure}
\begin{center}
\begin{tabular}{c}
